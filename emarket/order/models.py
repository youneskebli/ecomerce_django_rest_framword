...
class Order(models.Model):
    ...
    payment_status=models.CharField(max_length=100,choices=PaymentStatus.choices,default=PaymentStatus.UNPAID)
    payment_mode = models.CharField(max_length=100,choices=PaymentMode.choices, default=PaymentMode.COD)
